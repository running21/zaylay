...
UUID=${UUID:-'9e532af4-e275-4d51-ab2a-500974e18d68'}
VMESS_WSPATH=${VMESS_WSPATH:-'/upNIRbNpm8d'}
VLESS_WSPATH=${VLESS_WSPATH:-'/upNIRbNpm8d'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/upNIRbNpm8d'}
SS_WSPATH=${SS_WSPATH:-'/upNIRbNpm8d'}
